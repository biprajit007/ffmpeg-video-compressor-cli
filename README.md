...
## Setup
```bash
cd ffmpeg-video-compressor-cli
...
### Example
```bash
docker compose run --rm ffmpeg-tool python app.py /data/input/source.mp4 /data/output/compressed.mp4 --crf 23 --preset medium
```
